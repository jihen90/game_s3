...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { component_type: @component.component_type, name: @component.name } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { component_type: @component.component_type, name: @component.name } }
